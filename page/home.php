...
// Mengambil aktivitas transaksi terbaru
            ...
            <div class="card dashboard-card h-100 border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h2 class="card-value-dashboard text-primary">
                            <?= $totalObat ?>
                        </h2>
            ...
            <div class="card dashboard-card h-100 border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h2 class="card-value-dashboard text-success">
                            <?= $totalSupplier ?>
                        </h2>
            ...
            <div class="card dashboard-card h-100 border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h2 class="card-value-dashboard text-info">
                            <?= $totalKaryawan ?>
                        </h2>
            ...
            <div class="card dashboard-card h-100 border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h2 class="card-value-dashboard text-purple">
                            <?= $totalPelanggan ?>
                        </h2>
            ...
            <div class="card dashboard-card h-100 border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h2 class="card-value-dashboard text-warning">
                            <?= $totalUser ?>
                        </h2>
            ...
            <div class="card dashboard-card h-100 border-0">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <h2 class="card-value-dashboard text-danger">
                            <?= $stokMenipis ?>
                        </h2>
